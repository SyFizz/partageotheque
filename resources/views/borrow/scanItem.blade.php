        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                <div class="max-w-xl">
                    ...
                    <form method="post" action="{{ route('borrow.stepTwo') }}" class="mt-6 space-y-6">
                        @csrf
                        @method('post')

                        <div>
                            <x-input-label for="item_name" :value="__('Identifiant du matériel')" />
                            <x-text-input autofocus id="item_name" name="item_name" type="text" class="mt-1 block" value="{{old('item_name')}}" autocomplete="item_name" />
